package com.example.benat.dao;

import com.example.benat.bbdd.HibernateUtil;
import com.example.benat.model.ModeloDeportista;
import com.example.benat.model.ModeloEquipo;
import com.example.benat.model.ModeloEvento;
import com.example.benat.model.ModeloParticipacion;
...
public class DaoParticipacion {
     ...
     */
    public static List<String> getIdEvento(int idDeportista) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
